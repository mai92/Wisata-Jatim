                    ...
                    <tbody>
                      <?php $i = 0;foreach ($data as $row) {$i++?>
                        <tr>
                          ...
                          <td><img src="<?=base_url('uploads/gambar')?>/<?=$row->gambar?>" alt="<?=$row->nama_wisata?>" height="32px" width="32px"></td>
                          <td>
                          <a href="<?=base_url('wisata/edit')?>/<?=$row->id_wisata?>" class="btn btn-primary btn-xs">Ubah</a>
