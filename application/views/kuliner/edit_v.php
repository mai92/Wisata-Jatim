          ...
          <h1>
           ...
           <ol class="breadcrumb">
            <li><a href="<?=base_url()?>"><i class="fa fa-dashboard"></i> Home</a></li>
             <li><a href="<?=base_url('kuliner')?>"><i class="fa fa-dashboard"></i> kuliner</a></li>
            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                    ...
                    <form action="<?=base_url('kuliner/edit')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?=$data->id_kuliner?>">
                      <div class="form-group">
                      <label for="">Nama kuliner</label>
                      <input type="text" class="form-control" name="nama_kuliner" id="" placeholder="Nama kabupaten / kota" value="<?=$data->nama_kuliner?>">
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <p class="help-block">Gambar kuliner</p>
                    </div>
                  </div><!-- /.box-body -->
