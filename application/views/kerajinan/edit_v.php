            ...
            <div class="col-xs-12">
              <div class="box">
                ...
                <div class="box-body">
                    ...
                    <form action="<?=base_url('kerajinan/edit')?>" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                    <input type="hidden" name="id" value="<?=$data->id_kerajinan?>">
                      <div class="form-group">
                      <label for="">Nama Kerajinan</label>
                      <input type="text" class="form-control" name="nama_kerajinan" id="" placeholder="Nama kabupaten / kota" value="<?=$data->nama_kerajinan?>">
                    </div>
                    <div class="form-group">
